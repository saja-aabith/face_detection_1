...
class Face_Recognizer:
    ...
    def draw_note(self, img_rd):
        ...
        cv2.putText(img_rd, "FPS:    " + str(self.fps.__round__(2)), (20, 130), self.font, 0.8, (0, 0, 0), 2,
                    cv2.LINE_AA)
        cv2.putText(img_rd, "Student count:  " + str(self.current_frame_face_cnt), (20, 160), self.font, 0.8, (0, 0, 0), 2,
                    cv2.LINE_AA)
        cv2.putText(img_rd, "Q: Quit", (20, 450), self.font, 0.8, (0, 0, 0), 2, cv2.LINE_AA)
